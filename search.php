				...
				<div class="panel panel-info panel-info-cart">
					<div class="panel-heading panel-heading-cart">
						<div class="panel-title">
							<div class="row">
								<div class="col-md-6">
									<h5><span class="glyphicon glyphicon-shopping-cart"></span> Result</h5>
								</div>
							</div>
						</div>
					</div>
...
<?php
	...
	if(!empty($_POST['searchproduct'])){
		...
		$query = "select * from products where CONCAT(`name`) like '%$search%'";
...
?>		
	...
	<h4 class="product-name"><strong>Products</strong></h4>
	<br>
		<div class="row">
		<br>
		<br>
			<div class="col-md-2"><img class="img-responsive" 	>		<?php	echo '<img src='.$row['image'].' />';?>
</div>
